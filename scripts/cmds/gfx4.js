module.exports = {
	...
	onStart: async function ({ api, event, args, Users }) {
		...
		const getWanted = await axios.get(`https://tanjiro-api.onrender.com/gfx4?text=${text}&text2=Senpai&api_key=tanjiro`, { responseType: "arraybuffer" }).then(res => res.data).catch(() => null);
